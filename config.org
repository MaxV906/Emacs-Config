...
#+begin_src emacs-lisp
  ...
  (use-package doom-themes
    :init (load-theme 'doom-Iosvkem 1))
#+end_src
...
#+begin_src emacs-lisp
    (use-package langtool
        :ensure t
        :bind (("C-c l d" . langtool-check-done)
            ("C-c l c" . langtool-check-buffer))
        :config
        (setq langtool-language-tool-jar "~/.local/share/LanguageTool-6.4/languagetool-commandline.jar"))
#+end_src
